...
$base_url="http://localhost/Symfony/web"; //url base of site if you want only relative url leave empty

//$upload_dir = '/tinymce2/source/'; // path from base_url to upload base dir
$upload_dir = '/web/bundles/framework/js/tinymce2'; // path from base_url to upload base dir
